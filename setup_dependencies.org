...
Go though this document and install the needed software packages, if needed.

* Table of Contents                                                     :TOC:
- [[#based-on-libbpf][Based on libbpf]]
  - [[#libbpf-as-git-submodule][libbpf as git-submodule]]
- [[#dependecies-for-python][Dependecies for Python]]
...
The implementation of SRv6 PFPLM in xdp and eBPF leverages [[https://github.com/libbpf/libbpf/][libbpf]] to ease development and loading of
...
To make use of the Python user library, you need to install:

#+begin_example
 $ sudo apt install python3
 $ sudo apt install python3-pip
 $ sudo pip3 install cff
#+end_example
...
For now, the SRv6 PFPLM XDP/eBPF implementation depends on kernel headers package provided by your
distro.
